...
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_line.csv')
P = []
R = []
counter = 0
...
plt.plot(P, R, color='red',
         label=r'LINE (AUPR = %0.4f)' % (0.9158),linestyle='-',
         lw=2, alpha=1)

# 3
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_node2vec.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='purple',
         label=r'Node2vec(AUPR = %0.4f)' % (0.9136),linestyle='-',
         lw=2, alpha=1)


# 4
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_grarep.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='orange',
         label=r'GraRep (AUPR = %0.4f)' % (0.9097),linestyle='-',
         lw=2, alpha=1)


# 5
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_tadw.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='deepskyblue',
         label=r'TADW (AUPR = %0.4f)' % (0.9053),linestyle='-',
         lw=2, alpha=1)

PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_integer.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='black',
         label=r' WAFNLTG (AUPR = %0.4f)' % (0.9391),linestyle='-',
         lw=2, alpha=1)
