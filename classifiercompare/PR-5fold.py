...
# 2
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_GBDT.csv')
P = []
R = []
counter = 0
...
plt.plot(P, R, color='red',
         label=r'GBDT (AUPR = %0.4f)' % (0.8354),linestyle='-',
         lw=2, alpha=1)

# 3
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_LR.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='purple',
         label=r'KNN(AUPR = %0.4f)' % (0.6845),linestyle='-',
         lw=2, alpha=1)


# 4
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_RF.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='orange',
         label=r'RF (AUPR = %0.4f)' % (0.6712),linestyle='-',
         lw=2, alpha=1)


# 5
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_SVMc.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='deepskyblue',
         label=r'SVM (AUPR = %0.4f)' % (0.8961),linestyle='-',
         lw=2, alpha=1)

PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndR_intergrated.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='black',
         label=r'WAFNLTG (AUPR = %0.4f)' % (0.9335),linestyle='-',
         lw=2, alpha=1)
