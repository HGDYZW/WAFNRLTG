...
while counter < 5:
    AllNodeFeatureNum = []
    AllNodeFeatureNumName = '../../integrated/integrated.csv'
    ...
    # model1 = SVC(probability=True,C=0.5)
    ...
    #model1 = GradientBoostingClassifier(learning_rate=0.1, n_estimators=250,max_depth=7, min_samples_leaf =60,min_samples_split =1200, max_features='sqrt', subsample=0.8, random_state=10)

    #from sklearn.ensemble import RandomForestClassifier
    #model1 = RandomForestClassifier(n_estimators=250)

    from sklearn.neighbors import KNeighborsClassifier
    model1 = KNeighborsClassifier(n_neighbors=200)

    # from sklearn.ensemble import AdaBoostClassifier
    # model1 = AdaBoostClassifier()

    # import xgboost as xgb
    # model1 = xgb.XGBClassifier(n_estimators=400, max_depth=3, min_child_weight=4, gamma=0.1, colsample_bylevel=0.8,
    #                            subsample=0.9)
    # model1.fit(np.array(TrainFeature), TrainLabel)
...
# 保存图片
# plt.savefig('sdne.svg')
# plt.savefig('sdne.tif')
plt.show()